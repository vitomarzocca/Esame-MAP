...
public class Dialoghi {
    ...
    public static void oggi()
    {
            ...
            System.out.println("\n--Partenza per la casa del boss--");
            System.out.println("Johnny e' pronto per riprendersi...");
            System.out.println("tutt' chell che e' o soi");
            System.out.println("--Grazie alle sue doti da scassinatore Johnny si riesci ad infiltrare nella casa del Boss ... --");
    ...
    public static void stanza2()
    {
            ...
            System.out.println("E' possibile muoversi verso: Ovest.");
        }
    public static void stanza3()
    {
            ...
            System.out.println("Un salotto rustico con un enorme "
                    ...
                    + "in pietra.");
            System.out.println("E' possibile muoversi verso: Nord, Ovest.");
    }
    ...
    public static void stanza4()
    {
            ...
            System.out.println("E' possibile muoversi verso: Nord, Sud, Est.");
        }
    public static void stanza5()
    {
            ...
            System.out.println("Una cucina scavolini di quelle sponsorizzate"
                    + " da Cracco.");
            System.out.println("E' possibile muoversi verso: Nord, Sud, Est, Ovest.");
    }
    ...
    public static void stanza6()
    {
            ...
            System.out.println("Si intravede uno specchio e dei sanitari"
                    ...
                    + "dei capi rom.");
            System.out.println("E' possibile muoversi verso: Sud, Est, Ovest.");
    }
    ...
    public static void stanza10()
    {
            ...
            System.out.println("E' possibile muoversi verso: Nord.");
    }
    ...
    public static void stanza11()
    {
            ...
            System.out.println("E' possibile muoversi verso: Sud."); 
    }
